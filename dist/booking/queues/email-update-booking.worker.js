...
new bullmq_1.Worker('send-update-booking-email', async (job) => {
    const { serviceName, staffName, customerName, customerEmail, customerPhone, status, day, startTime, endTime, duration } = job.data;
    await (0, send_email_booking_utils_1.sendEmailUpdateBookingInformation)(customerEmail, serviceName, staffName, customerName, customerPhone, status, day, startTime, endTime, duration);
}, {
