...
// ĐĂNG XUẤT
AuthRouter.get('/logout', auth_guard_1.AuthGuard.RequireRefreshToken, sign_out_controller_1.SignOutController);
// ĐĂNG KÝ
...
AuthRouter.post('/registeration/createPassword', auth_guard_1.AuthGuard.RequireAuth, create_password_controller_1.createPasswordController.createNewPasswordByRegisterationFlow);
// QUÊN MẬT KHẨU
...
AuthRouter.post('/forgot-password/createPassword', auth_guard_1.AuthGuard.RequireResetToken, create_password_controller_1.createPasswordController.createPasswordByForgotFlow);
// REFRESH TOKEN
AuthRouter.post('/refresh-tokens', auth_guard_1.AuthGuard.RequireRefreshToken, refresh_token_controller_1.RefreshTokenController);
