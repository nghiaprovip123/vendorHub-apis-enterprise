...
// ĐĂNG XUẤT
AuthRouter.get('/logout', sign_out_controller_1.SignOutController);
// ĐĂNG KÝ
...
AuthRouter.post('/registeration/createPassword', create_password_controller_1.createPasswordController.createNewPasswordByRegisterationFlow);
// QUÊN MẬT KHẨU
...
AuthRouter.post('/forgot-password/createPassword', create_password_controller_1.createPasswordController.createPasswordByForgotFlow);
// REFRESH TOKEN
AuthRouter.post('/refresh-tokens', refresh_token_controller_1.RefreshTokenController);
