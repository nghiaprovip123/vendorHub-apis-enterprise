...
const delete_image_helper_utils_1 = require("@/common/utils/delete-image-helper.utils");
const deleteStaffService = async (input) => {
    ...
    if (input.public_id) {
        try {
            await (0, delete_image_helper_utils_1.deleteAssetFromCloudinary)(input.public_id);
        }
        catch (err) {
